        ...
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                <h1 className="fs-4 text-center text-muted">
                    We pioneered the discount broking model in India. <br /> Now, we are breaking ground with our
                    technology.
                </h1>
            </div>
            ...
            <div className="row p-5 mt-5 border-top text-muted fs-6" style={{ lineHeight: '1.8', fontSize: '1.2em' }}>
                ...
                <div className="col-6 p-5">
                    ...
                    <p>
                        ...
                        , our fintech fund and incubator, has invested in several fintech startups with the goal of
                        growing the Indian capital markets.
                    </p>
                    <p>
                        And yet, we are always up to something new every day. Catch up on the latest updates on our blog
                        or see what the media is saying about us or learn more about our business and product
                        philosophies.
                    </p>
                </div>
            </div>
